...
**PLEASE NOTE:** Since the currently stable version `1.7.x` cannot be pushed to rubygems _(due already released version 1.8.x)_ you have to use the branched gem definition.
