...
[![Branch Version](https://img.shields.io/badge/gem_version-3.0.3-green.svg)](http://github.com/ruby-smart/elasticsearch_record)
...
- This is the `rails-7-2-stable`-branch, which supports rails **7.2** _(see section 'Rails_Versions' for supported versions)_
